...
try
{
	...
	if ( typeof global.startBatch == "undefined" ) {
		...
		// You might consider changing the headers to dublin core standards, ex "dc.title" (preparation for SIPR) 
		...
		cValue: "FileName\tTitle\tAuthor\tSubject\tKeywords\tDescription\tCreationDate\tCategory\tCompany\tStatus\tModDate\tCreator\tSourceModified\tProducer\tContactEmail\r\n"});
			...
			//You can add more if you want, or remove some... 
			//BUT the custom tag catcher will get them anyway since they are built into every pdf
			global.masterTags = [];

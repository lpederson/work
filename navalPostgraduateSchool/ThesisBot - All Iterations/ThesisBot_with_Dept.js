...
if ( typeof global.startBatch == "undefined" ) {
	...
	cName: "mySummary.xls",
	cValue: "dc.contributor.author\tdc.title\tdc.date\tdc.date.issued\tdc.publisher\tdc.description.abstract\tdc.subject.author\tdc.contributor.advisor\tdc.contributor.secondreader\tetd.thesisdegree.name\tetd.thesisdegree.level\tetd.thesisdegree.discipline\tdc.description.service\tdc.contributor.department\tpath\r\n"});
}
/*
else
{
